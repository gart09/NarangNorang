...
@NoArgsConstructor
@AllArgsConstructor
	public class MemberProfileCardUpdateResponseDto {
		private Long id;
		private String name;
		...
		public static MemberProfileCardUpdateResponseDto from(MemberProfileCard memberProfileCard){
			return MemberProfileCardUpdateResponseDto.builder()
